...
for n in np.arange( 100, 1200, 200):
    ...
    print 'no. ran points', n, 'num integral', round(fInt, 4), 'exact', fct_Fxy_exact( xmax, ymax) - fct_Fxy_exact( xmin, ymin)
print 'Part B'    
for n in np.arange( 100, 1200, 200):
    fInt = int_utils.monteCarlo( fct2_xy, fct_gxy, xmin-1, xmax+1, ymin-1, ymax+1, n)
    print 'no. ran points', n, 'num integral', round(fInt, 4), 'exact', fct2_Fxy_exact( xmax, ymax) - fct2_Fxy_exact( xmin, ymin)
#================================================
#            plotting
#================================================
