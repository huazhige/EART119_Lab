...
# -*- coding: utf-8 -*-
"""
Created on Wed May  8 08:37:36 2019
...
def my_Secant( fct, x0, x1, tol = 1e-5, N = 50):
    x0 = float( x0)
    x1 = float( x1)
    i=0
...
r1 = my_Secant( fx1, -1, 1, tol = .000001, N = 50)
r2 = my_Secant( fx2, -10, 10, tol = .000001, N = 50)
r3 = my_Secant( fx3, -10, 10, tol = .000001, N = 50)
...
plt.savefig( '119_midterm_plot#2.png')
