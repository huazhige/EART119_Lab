...
def fct_BC_L( t, fAmp, w):
    ...
    :param curr_t: 
    :param fAmp: -Amplitude-- change in temp form day to night
    :return: 
    """
...
def fct_u_exact( t, x, fAlpha, fAmp, w):
    ...
    :param t: - time
    :param fAmp: - change in temperature
    :param w: - frequency of variations
    :return: explicit solution
    """
    # TODO return exact solution
    return fAmp*np.exp(-x*(w/(2*fAlpha))**0.5)*\
            np.cos(-x*(w/(2*fAlpha))**1./2. + w*t)
