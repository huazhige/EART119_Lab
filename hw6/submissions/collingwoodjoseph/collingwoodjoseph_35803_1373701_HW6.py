...
#_______________ANSWERS TO QUESTIONS_____________________________
"""
1) A depth of at least 2 meters is needed to reach a temerature variation of
    less than one degree.
3) If the surface temps were +/-80 C then you should dig at least 2.25 meters.
"""
#=========================0===========================================
...
def fct_u_exact( t, x, fAlpha, fAmp, w):
    ...
    return fAmp*np.exp((-x)*np.sqrt(w/(2*fAlpha)))*np.cos(((-x)*
                     np.sqrt(w/(2*fAlpha)))+w*t)
