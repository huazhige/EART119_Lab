...
Part 1: About 2m below the surface.
Part 2: (see plot)
Part 3: About 2.3m Below the surface
"""
...
for n in range( len(a_t)):# loop over time increments
    ...
    if (n+1)%plot_step == 0:
        ...
        plt.pause( 0.1)
        plt.savefig( 'Prob 6 figure')
"""
('delta t: ', 86.4, 'in [s],   stability lim for delta t: ', 229.81901752370007)
('space', 60, 60, 0.06779661016949153, 0.06779661016949153)
('time', 10001, 10001, 86.4, 86.4)
"""
