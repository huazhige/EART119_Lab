...
def fct_u_exact( t, x, fAlpha, fAmp, w):
    ...
    return fAmp*np.sin(2*np.pi/w * t)

#=====================================================================
#                   params
#=====================================================================
f_Alpha = 1*10**-5 #m2/s Mars surface 
f_L     = 4    #m depth to safety
# boundary condition
f_Uin   = 50 # in degree C, left boundary
f_Uout  = 0 # in degree C, right boundary
...
#########plotting
plot_step = 100 #plot every nth step
...
for n in range( len(a_t)):# loop over time increments
    ...
    if (n+1)%plot_step == 0:
        ax1.cla()
        ax1.set_title( 'Time Step: %.2f [d]'%( a_t[n]/(240*3600)))
...
#                     
#=====================================================================
"Question: At what depth is the expected temperature variation less than ~1 degree?"
"Answer: a depth of 6 meters"

#============================4========================================
#                     
#=====================================================================
"Answer: Still to the same depth. Heat flux in this instance is a function of periodicity, not temperature."
