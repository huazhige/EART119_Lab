#! python2.7
"""
ASTR119 HW 6, due 05/31/19
Andreas Kooi


1.) ~2 m down. The variance of temperature here is low(see plots attached:
    HW6_akooi_plots_amplitude_50.pdf)
2.) (plots attached, with numerical and analytical solutions)
3.) ~2.5 to 3 m down, perhaps 3 m to be safe. I found this by plotting with 
    f_Uin set to 80. (see: HW6_akooi_plots_amplitude_80.pdf)
