...
"""
1) The expected temperature variation less than ~1 degree 
    at about 2 m down as shown by the blue line.

3) If the temperature fluctets by +/- 80, the depth for a 
    variation less than ~1 would be about 2.26 m. 
"""
