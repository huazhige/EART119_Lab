...
Answers to questions:
    1. Temp variation less than ~1 at around a depth of 2 meters
    3. Also about 2 meters, but slightly more than 1 because the change in temp is greater
...
def fct_u_exact( t, x, fAlpha, fAmp, w):
    ...
    return fAmp * np.exp(-x * (w/(2*fAlpha))**1/2) * np.cos((-x * (w/(2*fAlpha))**1/2) + w*t)
