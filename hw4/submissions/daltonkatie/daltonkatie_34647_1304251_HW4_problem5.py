# -*- coding: utf-8 -*-
"""
 Compute the velocity (dz/dt) and acceleration (dz2/d2t)
 at every point in time using a central difference approach.
 Create three different subplots of position, velocity and
 acceleration as a fct of t
"""
import numpy as np
import matplotlib.pyplot as plt

data_z = np.genfromtxt('HW4_vertTraj.txt', dtype = float, skip_header = 1).T
