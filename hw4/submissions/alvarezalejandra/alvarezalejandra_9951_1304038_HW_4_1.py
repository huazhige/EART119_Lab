...
#=======================================================================================
a_t = np.linspace( 0, 7*w, num = 1000) # convert to martian days
a_T = fct_T( a_t, f_Tm, f_dA)
#print(type(np.random.randn(N)*f_sigma))
# add some noise
...
#os.chdir( 'data') #set to save figure to current working directory of .py file
plt.savefig( 'dir_out')
plt.show()
