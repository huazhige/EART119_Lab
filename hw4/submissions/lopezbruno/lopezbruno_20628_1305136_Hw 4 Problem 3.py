# -*- coding: utf-8 -*-
"""
Created on Sun May  5 22:54:52 2019

@author: Bruno Lopez
"""
'''
breaks the while loop if the convergence is smaller
than a really small number
'''
...
def my_Newton( fct, df_dt, x0, tol = 1e-4, N = 20):
    ...
    while abs( fct( xn)) > tol and i < N: # could also set fct. to ~0 to find root instead of min.
        ...
        xn = float( x_next)
        i += 1
    #If the convergence is less than a really small number
