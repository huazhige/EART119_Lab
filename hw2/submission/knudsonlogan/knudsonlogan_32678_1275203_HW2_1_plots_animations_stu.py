...
#------------------------------------------------------------------------
os.chdir( data_dir)
# load seismicity and well data using loadtxt DONE
...
for i in range( at_bin.shape[0]-1):
    ...
    xpt_eq ,ypt_eq = m( mSeis[1][sel_eq], mSeis[2][sel_eq])
...
From the plot in part C we can observe that earthquake rates signifigantly increase at the 
start of 2014 and are trending towards historical values at the end of the dataset.
I suspect well injection is the culprit to this abnormal increase in earthquake activity 
