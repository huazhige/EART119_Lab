...
sinw0t = np.sin(dPar['w0']*a_t)
preFacAna = dPar['F']/(dPar['w0']**2 - dPar['w']**2)
# :TODO  - write down the analyitcal soltuion
ay_ana1   = ((25/18)*np.cos( dPar['w0']*a_t)) + ((5/4)*sinw0t)+((a_t/(2*dPar['w0']))*fct_t)
# envelope
...
ax.plot( a_t,   ay_ana1,   'k-', lw = 3, alpha = .3, label = 'num - displ.')
