...
c1 =0
c2=0
ay_ana1     = c1*np.cos(dPar['w0']*a_t) + c2*np.sin(dPar['w0']*a_t) + (preFacAna*a_t*np.sin(dPar['w0']*a_t))
...
print """w0~w does not give us realistic results. From our graph, we can
see the change in displacement increases to larger and larger
distances, and will eventually reach infinity as time
progresses. In reality there would be some type of dampening
force present, such as friction, that would prevent this from happening."""
